...
def update_scattergraph(entered_site, range_slider):
    if entered_site == 'All':
        lbound, ubound = range_slider
        data = (spacex_df['Payload Mass (kg)'] > lbound) & (spacex_df['Payload Mass (kg)'] > ubound)
        fig = px.scatter(data, x = 'Payload Mass (kg)', y = 'class',
        color = 'Booster Version')
    else:
        lbound, ubound = range_slider
        data = (spacex_df[spacex_df['Launch Site'] == entered_site]) & (spacex_df['Payload Mass (kg)'] > lbound) & (spacex_df['Payload Mass (kg)'] > ubound)
        fig = px.scatter(data, x = 'Payload Mass (kg)', y = 'class',
        color = 'Booster Version')
    return fig
